...
export default function Home() {
  return (
    <>
      ...
      ></div>
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen min-w-screen p-8 pb-20 gap-16 sm:p-20 font-(family-name:--font-geist-sans)">
